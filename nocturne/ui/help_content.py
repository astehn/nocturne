...
_t("upscale", "Upscale Crop",
    ...
    _t("starless_levels", "Starless Levels",
       ...
       "strip underneath says which end is which, and the two figures in the panel read out "
       "exactly where you have put them. The handles cannot cross. <b>Reset</b> puts them back "
       ...
       "it back. Scroll to zoom, drag to pan, or use <b>+</b> / <b>−</b> / <b>Fit</b>.</p>"
       ...
       "doing and the words tell you where you started.</p>"
       "<h4>Tips</h4>"
