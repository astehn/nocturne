...
_TOPIC_LIST = (
    ...
    _t("stacking", "Stacking",
       ...
       "<p>Grading measures three things per frame: how many stars it can find, how big those "
       "stars are (<b>FWHM</b> — bigger means softer), and how bright the sky is. Strictness only "
       "decides where the line falls on the star-size measurement.</p>"
