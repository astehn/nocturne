...
_TOPIC_LIST = (
    ...
    _t("background", "Background extraction",
       ...
       "<p><b>Light</b> removes about half of it, using a stiffer model that follows only the "
       "broadest sky-glow. Reach for it when your target FILLS the frame — a large galaxy such as "
       "M31, or a nebula spanning most of the picture. A model free to follow local structure will "
       "mistake the object's faint outer parts for sky and subtract the very thing you came for, "
       "and no later step can put that back. If Strong leaves your object looking flat or hollowed "
       "out at the edges, that is what happened: undo and try Light.</p>"
       "<h4>Tips</h4>"
