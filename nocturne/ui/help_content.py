...
_TOPIC_LIST = (
    ...
    _t("color_balance", "Colour Balance",
       ...
       "<p><b>Show the mask</b> puts the band itself on screen. It follows the "
       "usual convention — <b>white reveals, black conceals</b>: white is fully "
       "adjusted, black is left completely alone, and the greys in between fade "
       "from one to the other. Look at it. A mask you cannot see is a mask you "
       "cannot trust, and it is the quickest way to tell whether you have actually "
       "selected the thing you meant to.</p>"
       "<p>Do not confuse this with the picture <b>Background extraction</b> shows "
       "you. That one is a difference rather than a mask, so its no-change point is "
       "mid-grey. Here, no change is black.</p>"
       "<h4>Tips</h4>"
