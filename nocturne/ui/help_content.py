...
_t("upscale", "Upscale Crop",
    ...
    _t("starless_levels", "Starless Levels",
       ...
       "<b>magenta</b> or <b>cyan</b> for two, <b>white</b> for all three — so white is the "
       "only case where the pixel really is black. <b>Amber</b> marks a pixel blown to white "
       "instead, and wins over a crushed channel in the same pixel because a blown core is "
       "the more urgent of the two. Drag until the first specks appear, then back off. It is "
       "the same idea as "
       ...
       "zoomed in, it covers only the visible region — <b>Fit</b> beside the preview puts "
       "it back. Scroll to zoom, drag to pan, or use <b>+</b> / <b>−</b> / <b>Fit</b>; in "
       "<b>Wipe</b> those three drive the wipe view itself, which magnifies the picture "
       "it was given rather than re-computing the mask.</p>"
